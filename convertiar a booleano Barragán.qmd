...
my_data2$utilizo_internet<-convertir_en_booleano(my_data$IP_III_04)

my_data2$utilizo_computadora<-convertir_en_booleano(my_data$IP_III_05)

my_data2$utilizo_celular<-convertir_en_booleano(my_data$IP_III_06)
```
